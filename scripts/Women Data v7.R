...
main = textGrob("\nWomen's Rights", gp = gpar(fontsize=18, fontface="bold", fontsize=18)),
sub = textGrob("*X-Axis depicts Total Number of Yes*", x=0, hjust=-0.5, vjust=0.1, gp = gpar(fontface = "italic", fontsize = 15)))

print(grobframe)
ggsave(filename="test.pdf",plot=grobframe,width = 20, height = 20, units = "in",dpi=300)
